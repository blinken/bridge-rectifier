...
![PCB](./board.png "Device PCB" | width=200)
...
![Aluminium enclosure 70x115mm internal size](./case.png | width=300)
![Aluminium enclosure, diagram with dimensions](./case-diagram.png | width=300)
